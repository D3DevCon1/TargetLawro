...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { away_goals: @prediction.away_goals, fixture_id: @prediction.fixture_id, home_goals: @prediction.home_goals, user_id: @prediction.user_id }
    end
  ...
  test "should update prediction" do
    put :update, id: @prediction, prediction: { away_goals: @prediction.away_goals, fixture_id: @prediction.fixture_id, home_goals: @prediction.home_goals, user_id: @prediction.user_id }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
